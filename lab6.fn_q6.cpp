...
//Write main function
int main(){
	int m,n,sumEven,sumOdd,sumSqureOdd,sumSqureEven;
	...
	//call function
	sumEven = sumEvenNumbers(m,n);	
	sumOdd = sumOddNumbers(m,n);
	sumSqureOdd = sumSqureOddNumbers(m,n);
	sumSqureEven = sumSqureEvenNumbers(m,n);
